...
#ifndef KALDI_NNET_NNET_BLCLSTM_PROJECTED_H_
#define KALDI_NNET_NNET_BLCLSTM_PROJECTED_H_
...
class BLClstmProjected : public MultistreamComponent {
 public:
  BLClstmProjected(int32 input_dim, int32 output_dim):
  ...
  Component* Copy() const { return new BLClstmProjected(*this); }
  ComponentType GetType() const { return kBLClstmProjected; }
  ...
  void PropagateFnc(const CuMatrixBase<BaseFloat> &in,
    ...
    if (prev_nnet_state_.NumRows() != NumStreams()) {
      ...
      f_propagate_buf_.RowRange(0, S).CopyFromMat(prev_nnet_state_); // use the 'previous-state',
    }
...
};  // class BLClstmProjected

}  // namespace nnet1
}  // namespace kaldi

#endif  // KALDI_NNET_NNET_BLCLSTM_PROJECTED_H_
